...
BENGALI_CMAP_REPLACEMENTS = {
    ...
    "ত ্য মত্র কন্দ্র": "তথ্য মিত্র কেন্দ্র",
    "ত ্যবাডির্ট": "তথ্যবোর্ড",
    "ই-কৃ ষে ত ্য পাটর্টাল": "ই-কৃষি তথ্য পোর্টাল",
    "ওয়োই-ফাই জিান": "ওয়াই-ফাই জোন",
    "বনামূ ল্য": "বিনামূল্যে",
    "প্রশক্ষেণ": "প্রশিক্ষণ",
    "উ ্যাগ": "উদ্যোগ",
    "শিংসাপত্র": "শংসাপত্র",
    "পয্যোন কাডির্নে": "প্যান কার্ডের",
    "পরষেবিার": "পরিষেবার",
    "বিয্যেবিস্থা": "ব্যবস্থা",
    "বিয্যেবিহারর": "ব্যবহারের",
    "মেৌলক": "মৌলিক",
    "স্মাটর্নেফান": "স্মার্টফোন",
    "ছোত্র-ছোত্রীদর": "ছাত্র-ছাত্রীদের",
    "শক্ষো র্থী": "শিক্ষার্থী",
    "সুবধা": "সুবিধা",
    "জিনয্যে": "জন্য",
    "শিহর": "শহর",
    "সমোজি": "সমাজ",
    "প্রযুক্তিত": "প্রযুক্তিতে",
    "হসাবি": "হিসাব",
    "দুনর্নীত কমেবি": "দুর্নীতি কমবে",
    "সমেয়েমেতা": "সময়মতো",
    "বিাজিারদর": "বাজারদর",
    "জিানত": "জানতে",
    "পারবিন": "পারবেন",
    "শিক্ষাথর্নীরা": "শিক্ষার্থীরা",
    "পড়াশিানা": "পড়াশোনা",
    "প্রতযাগতামেূলক": "প্রতিযোগিতামূলক",
    "কয্যোশিলস": "ক্যাশলেস",
    "লনদন": "লেনদেন",
    "অভয্যেস্ত": "অভ্যস্ত",
    "উপসংহারি": "উপসংহার",
    "মোনু ষের": "মানুষের",
    "সু যাগ-সুবিধা": "সুযোগ-সুবিধা",
    "সহজিলভয্যে কর তালা": "সহজলভ্য করে তোলা",
    "প্রজিক্টরি": "প্রজেক্টের",
    "প্রজক্টের": "প্রজেক্টের",
    "পাটর্টাল": "পোর্টাল",
    "রিপাটর্ট": "রিপোর্ট",
    "প্রজিক্ট": "প্রজেক্ট",
    "কাজি": "কাজ"
